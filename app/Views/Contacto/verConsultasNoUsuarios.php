...
<div class="container">
    ...
    <div class="row text-center">
        <div class="col">
            <p class="seccion-descripcion fs-1">Lista de consultas de usuarios no registrados</p>
            <hr>
        </div>
    </div>
    <!-- Filtro de Fecha -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <?php if($value['leido'] == 0): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?=base_url('listaConsultasNoUsuarios')?>" class="btn btn-primary btn-sm" type="button">
                                                            Aceptar
                                                        </a>
                                                <?php endif ?>
                                                </div>
