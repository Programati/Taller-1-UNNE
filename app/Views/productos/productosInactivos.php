...
<div class="container mt-2">
    ...
    <div class="row my-3 d-flex justify-content-between">
        ...
        <div class="col-12 col-sm-6 g-sm-0 d-flex align-items-end">
            ...
            <a href="<?=base_url('productosOff') ?>" class="btn btn-custom btn-sm" type="button">
                Traer todos
            </a>
        </div>
        ...
        <div class="col-12 col-sm-6 g-sm-0">
            ...
            <div class="row g-0">
                <div class="col d-flex justify-content-end flex-fill flex-wrap">
                    <form class="d-flex" role="search" action="<?=base_url(route_to('buscarProductoInActivo')) ?>" method="POST">
    ...
    <?php else: ?>
        <div class="container my-5" style="height:40vh">
            <div class="row">
                ...
                <div class="col-10">
                    <p class="fs-2 fw-bolder">No hay productos INACTIVOS que coincidan con tu búsqueda</p>
                    <ul>
